package store.pattern.impl;

import store.pattern.Print;

public class NobugPrint implements Print{
	...
	public void doPrint() {
	       ...
	       System.out.println("----------------------------------------------------------------------------------------------------------");
	        ...
	        System.out.println("               ┃　　  ┃                                                                          ");
	        System.out.println("　　　　　　　　　┃　　  ┃ + + + +                        ");
	        System.out.println("　　　　　　　　　┃　　　┃　Code is far away from     bug with the animal protecting ");
